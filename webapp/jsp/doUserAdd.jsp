...
<div style="height: 400px; display: flex; flex-direction: row; justify-content: center; align-items: center">
    <div class="panel panel-default" style="width: 40%">
        <div class="row clearfix" id="head" style="
    background-position: 50% 50%;background-repeat:no-repeat;
background-size: 100% 100%;">
            <div class="col-md-12 column"
                 style="height: 80px;text-align: center;font-size: 30px;color: #e8eff1">
                阿仁图书馆
            </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <div style="display: flex; justify-content: flex-end; margin-top: 20px">
                ...
                <a href="${pageContext.request.contextPath}/userAdd" class="btn btn-primary" role="button"
                   style="margin-right: 20px">
                    继续添加
                </a>
            </div>
