...
<div class="container" id="container" style="width: 100%">
    ...
    <div class="row clearfix" id="body" style="display: flex; min-height: 800px">
        ...
        <div class="col-md-9 column" id="content">
            ...
            <div class="form">
                <div class="formbox">
                    <form role="form" action="${pageContext.request.contextPath}/doUserAdd" method="post"
                        ...
                        <input id="sjh" name="tel" value="$" type="number" placeholder="手机号码" required/> <!--pattern="^1[3-9][0-9]{9}$-->
                        <p style="padding-left: 20px"></p>
                        <br>
                        <!--性别-->
                        ...
                        <button>
                            <a style="border: 0; color: whitesmoke; text-decoration:none" href="${pageContext.request.contextPath}/userList">取消添加</a>
                        </button>
                    </form>
                </div>
            </div>
