    ...
    <div class="row clearfix" id="head">
        ...
        <div class="col-md-12 column" style="position: fixed;width: 100%;top: 0;z-index: 99; <%--导航栏固定悬浮在最上层--%>
            ...
            <div style="display: flex; justify-content: flex-start">
                <div style="position: absolute; left: 85px; top: 18px">
                    <img src="${pageContext.request.contextPath}/static/images/sun.png"
                         style="width: 40px; height: 40px">
                </div>
                <div style="position: absolute; left: 130px; top: 18px; font-size: 30px; color: white">
                    阿仁图书馆
                </div>
            </div>
...
<%--                        <button>--%>
<%--                            <a style="border: 0; color: whitesmoke; text-decoration:none" href="${pageContext.request.contextPath}/personal?userId=${mUser.userId}" onClick="javascript:history.go(-1)">取消修改</a>--%>
<%--                        </button>--%>
                    </form>
                </div>
            </div>
