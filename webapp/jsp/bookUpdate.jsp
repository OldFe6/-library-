...
<div class="container" id="container" style="width: 100%">
    ...
    <div class="row clearfix" id="body" style="display: flex; min-height: 600px">
        ...
        <jsp:include page="left.jsp">
            <jsp:param name="navItem" value="bookManage"/>
        </jsp:include>
        <div class="col-md-9 column" id="content">
            ...
            <div class="form">
                <div class="formbox">
                    <form role="form" action="${pageContext.request.contextPath}/doBookUpdate" method="post"
                        ...
                        <input id="zh" name="bookName" value="${mBook.bookName}" type="text" placeholder="请输入书名" required/>
                        <p style="padding-left: 20px"></p>
                        <br>
                        <!--用户名-->
                        <label for="username" class="zhmm"><p>作者：</p></label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="username" name="author" value="${mBook.author}" type="text" placeholder="请输入作者" required/>
                        <p style="padding-left: 20px"></p>
                        <br>
                        <!--密码-->
                        <label for="mm" class="zhmm"><p>出版社：</p></label>
                        &nbsp;&nbsp;&nbsp;
                        <input id="mm" name="publish" value="${mBook.publish}" type="text" placeholder="请输入出版社" required/>
                        <p style="padding-left: 20px"></p>
                        <br>
                        <!--手机号-->
                        <label for="sjh" class="zhmm"><p>图书库存：</p></label>
                        <input id="sjh" name="bookCount" value="${mBook.bookCount}" type="text" placeholder="请输入库存" required/> <!--pattern="^1[3-9][0-9]{9}$-->
                        <p style="padding-left: 20px"></p>
                        <br>
                        <!--性别-->
                        <label for="sex" class="zhmm"><p>图书价格：</p></label>

                        <input id="sex" name="price" value="${mBook.price}" type="text" placeholder="请输入价格" required/>
                        ...
                        <button>
                            <a style="border: 0; color: whitesmoke; text-decoration:none" href="${pageContext.request.contextPath}/bookList" onClick="javascript:history.go(-1)">取消修改</a>
                        </button>
                    </form>
                </div>
            </div>
