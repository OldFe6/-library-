    ...
    <div class="panel panel-default" style="width: 40%">
        ...
        <div class="panel-body">
            ...
            <div style="display: flex; justify-content: flex-end; margin-top: 20px">
                <a href="${pageContext.request.contextPath}/myShopping?userId='${sessionScope.mUser.userId}'" class="btn btn-primary" role="button"
                   style="margin-right: 20px">
                    返回够买记录列表
                </a>
                <a href="${pageContext.request.contextPath}/bookList" class="btn btn-primary" role="button"
                   style="margin-right: 20px">
                    继续够买
                </a>
            </div>
